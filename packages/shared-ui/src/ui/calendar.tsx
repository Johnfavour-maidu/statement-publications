  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1 rounded-md border border-input hover:bg-accent hover:text-accent-foreground inline-flex items-center justify-center"
        ),
        button_next: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1 rounded-md border border-input hover:bg-accent hover:text-accent-foreground inline-flex items-center justify-center"
        ),
