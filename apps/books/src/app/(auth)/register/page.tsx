    ...
    >
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] border border-white/60 p-8">
        <div className="text-center mb-6">
          <h1 className="text-[22px] font-bold text-[#1D1D1D]">Create Account</h1>
          <p className="text-[13px] text-gray-500 mt-1.5">Join Statement Books and discover your next read</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            ...
            className="w-full h-11 bg-[#D8B27A] hover:bg-[#8A6A4A] text-[#1D1D1D] hover:text-white font-semibold rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-[13px]"
          >
            {isLoading ? (
