...
export function HeroWaveBottom() {
  return (
    <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none" style={{ height: "80px" }}>
      ...
      >
        <path
          d="M0,40 C120,70 240,80 360,65 C480,50 600,20 720,15 C840,10 960,30 1080,45 C1200,60 1320,55 1380,50 L1440,45 L1440,80 L0,80 Z"
          fill="white"
        />
        <path
          d="M0,50 C160,70 320,75 480,60 C640,45 800,25 960,30 C1120,35 1280,55 1360,60 L1440,55 L1440,80 L0,80 Z"
          fill="white"
          opacity="0.5"
        />
      </svg>
...
export function ServicesGridWaveBottom() {
  return (
    <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none" style={{ height: "80px" }}>
      <svg
        viewBox="0 0 1440 80"
...
export function PricingWaveBottom() {
  return (
    <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none" style={{ height: "80px" }}>
      <svg
        viewBox="0 0 1440 80"
...
export function CTAWaveTop() {
  return (
    <div className="absolute top-0 left-0 w-full overflow-hidden leading-none rotate-180" style={{ height: "80px" }}>
      ...
      >
        <path
          d="M0,25 C180,60 360,70 540,55 C720,40 900,20 1080,30 C1260,40 1380,55 1440,60 L1440,80 L0,80 Z"
          fill="white"
        />
        <path
          d="M0,40 C240,65 480,70 720,50 C960,30 1200,45 1380,55 L1440,50 L1440,80 L0,80 Z"
          fill="white"
          opacity="0.4"
        />
      </svg>
