...
const authorIcons = [
  ...
  { label: "Edit 3", path: "M12 20h9 M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" },
];
...
export function HeroRevolvingIcons() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full opacity-20 blur-[120px]" style={{ background: "radial-gradient(circle, #EBC9A8, transparent)" }} />
      <div className="absolute -bottom-32 -right-32 w-[400px] h-[400px] rounded-full opacity-15 blur-[100px]" style={{ background: "radial-gradient(circle, #D8B27A, transparent)" }} />

      {/* Orbit container */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="hero-orbit relative" style={{ width: 560, height: 560 }}>
          {authorIcons.map((icon, i) => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/60 backdrop-blur-sm border border-[#D8B27A]/20 shadow-sm">
                  <svg
                    className="w-5 h-5 text-[#8A6A4A]/50"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="1.5"
