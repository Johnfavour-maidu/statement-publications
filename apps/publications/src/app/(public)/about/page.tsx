                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-[2px] rounded-xl bg-[length:300%_300%] animate-gradient bg-gradient-to-r from-[#EBC9A8] via-[#D8B27A] to-[#F2D8BE]">
                        <div className="text-center p-4 rounded-[10px] bg-[#FDF6EE]">
                          ...
                          <div className="text-2xl font-bold text-charcoal"><CountUp end={10000} suffix="+" /></div>
                          <div className="text-xs text-dark-gray/70">Books Published</div>
                        </div>
                      </div>
                      <div className="p-[2px] rounded-xl bg-[length:300%_300%] animate-gradient bg-gradient-to-r from-amber-300 via-amber-400 to-amber-500">
                        <div className="text-center p-4 rounded-[10px] bg-amber-50">
                          ...
                          <div className="text-2xl font-bold text-charcoal"><CountUp end={5000} suffix="+" /></div>
                          <div className="text-xs text-dark-gray/70">Active Authors</div>
                        </div>
                      </div>
                      <div className="p-[2px] rounded-xl bg-[length:300%_300%] animate-gradient bg-gradient-to-r from-emerald-300 via-emerald-400 to-emerald-500">
                        <div className="text-center p-4 rounded-[10px] bg-emerald-50">
                          ...
                          <div className="text-2xl font-bold text-charcoal"><CountUp end={50} suffix="+" /></div>
                          <div className="text-xs text-dark-gray/70">Countries</div>
                        </div>
                      </div>
                      <div className="p-[2px] rounded-xl bg-[length:300%_300%] animate-gradient bg-gradient-to-r from-blue-300 via-blue-400 to-blue-500">
                        <div className="text-center p-4 rounded-[10px] bg-blue-50">
                          ...
                          <div className="text-xs text-dark-gray/70">Royalties Paid</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className={`p-[2px] rounded-2xl bg-[length:300%_300%] animate-gradient bg-gradient-to-r ${t.gradientBorder} hover:shadow-xl transition-all duration-300 hover:scale-[1.02]`}>
                  <div className={`rounded-[14px] p-4 ${t.bg} flex flex-col h-full`}>
                    ...
                    <div className={`flex items-center gap-2.5 pt-3 border-t-2 ${t.separatorColor}`}>
                      <div className={`h-9 w-9 rounded-full bg-gradient-to-br ${t.color} flex items-center justify-center text-[10px] font-bold text-white shadow-sm`}>
