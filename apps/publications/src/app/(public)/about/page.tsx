...
const testimonials = [
  ...
  { name: "Abena Osei", role: "Business Author", quote: "As a business consultant, I needed a professional platform to publish my leadership book. Statement delivered exceptional quality — from formatting to global distribution across 40+ countries.", rating: 5, color: "from-[#D8B27A] to-[#EBC9A8]", quoteColor: "text-[#8A6A4A]", bg: "bg-[#F2D8BE]", gradientBorder: "from-[#D8B27A] via-[#C9A06A] to-[#EBC9A8]", separatorColor: "border-[#D8B27A]" },
  { name: "Dr. Emmanuel Mensah", role: "Academic Researcher", quote: "Publishing my research through Statement was seamless. The platform handled complex formatting with ease, and my academic work is now accessible to readers and institutions worldwide.", rating: 5, color: "from-blue-500 to-indigo-600", quoteColor: "text-blue-700", bg: "bg-blue-200", gradientBorder: "from-blue-300 via-blue-400 to-blue-500", separatorColor: "border-blue-400" },
  { name: "Nana Ama Brown", role: "Children's Book Author", quote: "My children's picture book required special attention to illustrations and layout. Statement's tools made it easy to showcase vibrant artwork. The response from parents and educators has been overwhelming.", rating: 5, color: "from-rose-500 to-pink-600", quoteColor: "text-rose-700", bg: "bg-rose-200", gradientBorder: "from-rose-300 via-rose-400 to-rose-500", separatorColor: "border-rose-400" },
  { name: "Pastor Samuel Koomson", role: "Faith-Based Author", quote: "Statement Publications understood my vision for reaching a global faith community. My devotional book is now available in bookstores across three continents. The support team was exceptional throughout.", rating: 5, color: "from-violet-500 to-purple-600", quoteColor: "text-violet-700", bg: "bg-violet-200", gradientBorder: "from-violet-300 via-violet-400 to-violet-500", separatorColor: "border-violet-400" },
  { name: "Esi Kyere", role: "Poet & Creative Writer", quote: "Poetry is often overlooked in publishing, but Statement treated my collection with the same care as any bestseller. The formatting preserved every line break, and sales have exceeded my expectations.", rating: 5, color: "from-teal-500 to-emerald-600", quoteColor: "text-teal-700", bg: "bg-teal-200", gradientBorder: "from-teal-300 via-teal-400 to-teal-500", separatorColor: "border-teal-400" },
];
