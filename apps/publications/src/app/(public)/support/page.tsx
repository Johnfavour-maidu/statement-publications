...
const categories = [
  ...
  { icon: Wrench, title: "Technical Support", description: "Report bugs or technical problems", color: "bg-orange-50 text-orange-600" },
...
const contactOptions = [
  ...
  { icon: MessageCircle, title: "Live Chat", description: "Chat with our support team in real-time.", action: "Coming Soon", href: "#" },
  { icon: FileText, title: "Submit a Ticket", description: "Submit a detailed support request for our team.", action: "Open Form", href: "/contact" },
];
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "How do I contact support?", a: "You can reach us via email at support@statementpub.com or through the contact form on this page. We typically respond within 24 hours." },
            ].map((faq, i) => (
