  ...
  return (
    <footer className="bg-[#1D1D1D] text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:w-[35%]">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <Input
                ...
                className="h-11 text-sm border-white/20 bg-white/10 text-white placeholder:text-white/40 rounded-lg flex-1"
                required
              />
        ...
        {/* Bottom Bar — Social | Copyright | Logo */}
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                title={social.label}
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 text-white/70 transition-all duration-300 hover:border-white hover:text-white hover:scale-110"
              >
          ...
          <Link href="/" className="inline-block">
            <img src="/logo.png" alt="Statement Publications" className="h-10 w-auto brightness-0 invert" />
          </Link>
        </div>
      </div>
    </footer>
